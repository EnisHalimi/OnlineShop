...
<div class="row justify-content-center">
        <div class="col-md-8">
            <h3 class="text-center">Ndrysho Aksion </h3>
                    <form method="POST" action="{{ route('aksion.update',$aksion->id) }}">
                        @csrf
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="regjistroModalLabel">Ndrysho Aksionin</h5>
